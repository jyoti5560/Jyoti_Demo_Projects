...
class MusicPlayerState extends State<MusicPlayer> with SingleTickerProviderStateMixin{
  ...
  AnimationController? iconController; // make sure u have flutter sdk > 2.12.0 (null safety)
  ...
  void initState() {
    ...
    audioPlayer.open(Audio('assets/sound/file_example_MP3_700KB.mp3'),autoStart: false,showNotification: true);
